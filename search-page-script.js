...
const loadAlbums = (albums) => {
    ...
    albums.forEach((element) => {
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
          <div class="card mb-4">
          <a href="https://striveschool-api.herokuapp.com/api/deezer/album/${element.album.id}">
            <img
            ...
            <div class="card-body">
              ...
              <p class="card-text text-center card-artist"><a href="https://striveschool-api.herokuapp.com/api/deezer/artist/${element.artist.id}">${element.artist.name}</a></p>
            </div>
          </div>
        </div>
